...
```bash
pip install kate-sdk[openai]                # Auto-instrument OpenAI SDK
pip install kate-sdk[anthropic-instrument]  # Auto-instrument Anthropic SDK
pip install kate-sdk[langchain]             # Auto-instrument LangChain / LangGraph
pip install kate-sdk[all]                   # All supported providers
```
